...
function highlightLine(line: string): React.ReactNode[] {
  ...
  const keywordSet = new Set([
    ...
    "import", "from", "export", "default", "return", "if", "else",
    "switch", "case", "while", "for", "in", "of", "new", "try",
    "catch", "finally", "throw", "extends", "implements", "async",
    "await", "true", "false", "null", "undefined", "this",
  ]);

  const parts = line.split(
    /(\b(?:const|let|var|function|class|interface|type|import|from|export|default|return|if|else|switch|case|while|for|in|of|new|try|catch|finally|throw|extends|implements|async|await|true|false|null|undefined|this)\b|"(?:[^"\\]|\\.)*"|'(?:[^'\\]|\\.)*'|`(?:[^`\\]|\\.)*`|\/\/.*$|\b\d+(?:\.\d+)?\b)/
  );
